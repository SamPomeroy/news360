...
export class Saved extends Component {
  render() {
    return (
      <div style={{width: '100vw', height:'92.2vh', overflow: 'auto', margin: 'auto', display: 'flex', flexWrap: 'wrap', overflowX: 'hidden', justifyContent: 'center', padding: '20px'}} className='bg-black text-white'>
        {
